...
IdCard.prototype.getBirthDay = function(format) {
    var birthDate = new Date(this._yearCode, this._monthCode - 1, this._dayCode);
    return format ? utils.formatDate(birthDate, format) : birthDate;
};
...
IdCard.prototype.repair = function() {
    ...
    if (!_validateCard(newCard).result) {
        return {
            result: 'fail',
            reason: '新证件号未通过合法性校验',
            value: newCard
